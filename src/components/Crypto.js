    ...
    <div className="crypto-main">
      <div className="crypto__container">
        <div className="crypto-header">
          <h1 className="crypto__h1">
            The most trusted cryptocurrency platform
          </h1>
          <p className="crypto__p">
        ...
        <div className="crypto-body">
          <div className="crypto-item">
            ...
            <h3 className="crypto-item-head">Secure storage</h3>
            <p className="crypto-item-faded">
              We store the vast majority of the digital assets in secure offline
              storage.
            </p>
            <p className="crypto-item-link">
          ...
          <div className="crypto-item">
            ...
            <h3 className="crypto-item-head">Protected by insurance</h3>
            <p className="crypto-item-faded">
          ...
          <div className="crypto-item">
            ...
            <h3 className="crypto-item-head">Industry best practices</h3>
            <p className="crypto-item-faded">
