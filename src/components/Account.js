    ...
    <div className="account">
      <div className="account__sub">
        ...
        <div className="account__header">
          <h1 className="account-h1">Get started in a few minutes</h1>
        ...
        <div className="accounts__wrapper">
          ...
          <div className="account__box">
            ...
            <h2 className="account__h2">Create an account</h2>
          </div>
          ...
          <div className="account__box">
            ...
            <h2 className="account__h2">Link your bank account</h2>
          </div>
          ...
          <div className="account__box">
            ...
            <h2 className="account__h2">Start buying & selling</h2>
          </div>
        </div>
      </div>
    </div>
